...
this pulls out the embedded [json-ld](https://json-ld.org/playground/), 

along with any other valid RDF embedded in those pages

Using [Linked](https://www.ontotext.com/knowledgehub/fundamentals/linked-data-linked-open-data/)-[Data](https://www.w3.org/standards/semanticweb/data) principles, you can just point to your org-URI and not have to copy the information over
